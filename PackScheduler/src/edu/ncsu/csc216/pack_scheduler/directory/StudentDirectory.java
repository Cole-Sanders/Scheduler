...
public class StudentDirectory {
	...
	/**
	 * Returns the student in student directory with the given ID. If there is no such student returns null.
	 * @param id the id of the student.
	 * @return the student with the passed in id or null if no student has that id.
	 */
