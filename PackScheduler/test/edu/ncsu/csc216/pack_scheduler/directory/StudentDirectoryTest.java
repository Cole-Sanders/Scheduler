...
public class StudentDirectoryTest {
	...
	public void testAddStudent() {
		...
		Exception e2 = assertThrows(IllegalArgumentException.class,
				() -> sd.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, "password", "differentPassword", MAX_CREDITS));
	...
	public void testGetStudentById() {
		...
		sd.addStudent("Bob", "Sande", "bsande2", EMAIL, PASSWORD, PASSWORD, MAX_CREDITS);
		assertEquals("Zahir", sd.getStudentById("zking").getFirstName());
		assertEquals(FIRST_NAME, sd.getStudentById(ID).getFirstName());
		assertEquals("Bob", sd.getStudentById("bsande2").getFirstName());
	}
